...
let attemp=0;
let userAttemp=Number(prompt('Please guess numbers between 1 and 20'));
...
while(attemp<6)
{
    ...
    {
         userAttemp=prompt('Correct, Try to guess another number :)');
         attemp++;
         score++;
    }  
}

    userAttemp=prompt('Sorry, Try another number :(');
    attemp++;
}
